...
<div class="modal fade" id="create" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  ...
  <div class="modal-dialog modal-notify modal-warning" role="document">
    ...
    <div class="modal-content">
      ...
      <!--Body-->
      <form name="form4" action='index.php?action=crudService&id=<?=$id?>' method='post'>
      <div class="modal-body">
        <div class="md-form mb-5">
          <i class="fas fa-user prefix grey-text"></i>
          <label data-error="wrong" data-success="right" for="form3">Libellé du service</label>
  ...
  <div class="modal-dialog modal-notify modal-warning" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="md-form mb-5">
          <i class="fas fa-user prefix grey-text"></i>
          <label data-error="wrong" data-success="right" for="libelleedit">Libellé du service</label>
          <input type="text" id="libelleedit" class="form-control validate" name='libelle'>
          <input type="hidden" id="dataId" name="id_service">
      ...
      <div class="modal-footer justify-content-center">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
          <button id="saveChanges" type="submit" class="btn btn-primary">Modifier le service</button>
      </div>
      </form>
    </div>
    <!--/.Content-->
  ...
  <div class="container">
    <div class="row mt-4">
      <div class="col-lg-6 d-flex justify-content-between align-items-center">
        <div>
          <h4 class="text-primary">Tout les services !</h4>
        </div>
        <div>
          ...
          <table class="table table-striped table-bordered text-center" id="table">
            ...
            <tbody>
                ...
                foreach($cruds as $crud){
                    $id_service = $crud->id_service;
                ?>
                <tr>
                    <td data-id="<?= $id_service ?>"><?= $id_service ?></td>
                    <td data-id="<?= $id_service ?>"><?= $crud->libelle ?></td>
                    <td>
                        <div class='d-flex text-center'>
                        <button data-id="<?= $id_service ?>" type="button" class="btn btn-sm btn-primary update" data-bs-toggle="modal" data-bs-target="#update">Modifier</button>
                        &nbsp;
                        <form action='index.php?action=crudService&id=<?=$id?>' method='post'>
...
function exportData(){
    ...
    /* add a new records in the array */
        ...
        link.setAttribute("download", "Service-users"+today+".csv");
