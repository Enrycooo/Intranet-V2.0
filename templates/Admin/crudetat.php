  ...
  <div class="modal-dialog modal-notify modal-warning" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-center">
          ...
          <button type="submit" class="btn btn-primary">Créer un état</button>
      </div>
      </form>
    </div>
    <!--/.Content-->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="md-form mb-5">
          ...
          <input type="hidden" id="dataId" name="id_etat">
          ...
          <table class="table table-striped table-bordered text-center" id="table">
            ...
            <tbody>
                ...
                foreach($cruds as $crud){
                    $id_etat = $crud->id_etat;
                ?>
                <tr>
                    <td data-id="<?= $id_etat ?>"><?= $id_etat ?></td>
                    <td data-id="<?= $id_etat ?>"><?= $crud->libelle ?></td>
                    <td>
                        <div class='d-flex text-center'>
                        <button data-id="<?= $id_etat ?>" type="button" class="btn btn-sm btn-primary update" data-bs-toggle="modal" data-bs-target="#update">Modifier</button>
                        &nbsp;
                        <form action='index.php?action=crudEtat&id=<?=$id?>' method='post'>
                            <input type="hidden" name='id_etat' value='<?=$id_etat?>'>
